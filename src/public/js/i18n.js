...
const translations = {
    en: {
        ...
        dashboard: {
            ...
            confirmRemoveDesc: 'You will no longer receive updates from this account.',
            ...
            deleteAccountDesc: 'Once you delete your account, there is no going back. All your data, subscriptions, and settings will be permanently removed.',
            ...
            willBeDeleted: 'The following will be deleted:',
            allSubscriptions: 'All your Twitter subscriptions',
            savedNews: 'All saved news items',
            accountSettings: 'Your account settings and preferences',
    ...
    tr: {
        ...
        dashboard: {
            ...
            confirmRemoveDesc: 'Bu hesaptan artık güncellemeler almayacaksınız.',
            ...
            deleteAccountDesc: 'Hesabınızı sildiğinizde geri dönüş yoktur. Tüm verileriniz, abonelikleriniz ve ayarlarınız kalıcı olarak kaldırılacaktır.',
            confirmDelete: 'Hesap Silmeyi Onayla',
            deleteWarning: 'Bu işlem geri alınamaz. Bu, hesabınızı kalıcı olarak silecek ve tüm verilerinizi sunucularımızdan kaldıracaktır.',
            willBeDeleted: 'Aşağıdakiler silinecektir:',
            allSubscriptions: 'Tüm Twitter abonelikleriniz',
            savedNews: 'Kaydedilmiş tüm haberler',
            accountSettings: 'Hesap ayarlarınız ve tercihleriniz',
            telegramConnection: 'Telegram bot bağlantısı',
            typeDelete: 'Onaylamak için DELETE yazın:',
            deleteAccountFinal: 'Hesabımı Sil',
            typeDELETE: 'Lütfen onaylamak için DELETE yazın',
            deleteSuccess: 'Hesap başarıyla silindi',
            deleteFailed: 'Hesap silinemedi',
            deleteError: 'Bir hata oluştu. Lütfen tekrar deneyin.'
        },
    ...
    es: {
        ...
        dashboard: {
            ...
            confirmRemoveDesc: 'Ya no recibirás actualizaciones de esta cuenta.',
            ...
            deleteAccountDesc: 'Una vez elimines tu cuenta, no hay vuelta atrás. Todos tus datos, suscripciones y configuraciones serán eliminados permanentemente.',
            confirmDelete: 'Confirmar Eliminación de Cuenta',
            deleteWarning: 'Esta acción no se puede deshacer. Esto eliminará permanentemente tu cuenta y todos tus datos de nuestros servidores.',
            willBeDeleted: 'Se eliminará lo siguiente:',
            allSubscriptions: 'Todas tus suscripciones de Twitter',
            savedNews: 'Todas las noticias guardadas',
            accountSettings: 'Tus configuraciones y preferencias',
            telegramConnection: 'Conexión del bot de Telegram',
            typeDelete: 'Escribe DELETE para confirmar:',
            deleteAccountFinal: 'Eliminar Mi Cuenta',
            typeDELETE: 'Por favor escribe DELETE para confirmar',
            deleteSuccess: 'Cuenta eliminada exitosamente',
            deleteFailed: 'No se pudo eliminar la cuenta',
            deleteError: 'Ocurrió un error. Por favor intenta de nuevo.'
        },
        nav: {
    ...
    de: {
        ...
        dashboard: {
            ...
            confirmRemoveDesc: 'Sie erhalten keine Updates mehr von diesem Konto.',
            ...
            deleteAccountDesc: 'Sobald Sie Ihr Konto löschen, gibt es kein Zurück mehr. Alle Ihre Daten, Abonnements und Einstellungen werden dauerhaft entfernt.',
            confirmDelete: 'Kontolöschung Bestätigen',
            deleteWarning: 'Diese Aktion kann nicht rückgängig gemacht werden. Dies löscht Ihr Konto und alle Ihre Daten dauerhaft von unseren Servern.',
            willBeDeleted: 'Folgendes wird gelöscht:',
            allSubscriptions: 'Alle Ihre Twitter-Abonnements',
            savedNews: 'Alle gespeicherten Nachrichten',
            accountSettings: 'Ihre Kontoeinstellungen und Präferenzen',
            telegramConnection: 'Telegram-Bot-Verbindung',
            typeDelete: 'Geben Sie DELETE ein um zu bestätigen:',
            deleteAccountFinal: 'Mein Konto Löschen',
            typeDELETE: 'Bitte geben Sie DELETE ein um zu bestätigen',
            deleteSuccess: 'Konto erfolgreich gelöscht',
            deleteFailed: 'Konto konnte nicht gelöscht werden',
            deleteError: 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.'
        },
        nav: {
            features: 'Funktionen',
            pricing: 'Preise',
    ...
    fr: {
        ...
        dashboard: {
            ...
            confirmRemoveDesc: 'Vous ne recevrez plus de mises à jour de ce compte.',
            ...
            deleteAccountDesc: 'Une fois que vous supprimez votre compte, il n\'y a pas de retour. Toutes vos données, abonnements et paramètres seront définitivement supprimés.',
            confirmDelete: 'Confirmer la Suppression du Compte',
            deleteWarning: 'Cette action ne peut pas être annulée. Cela supprimera définitivement votre compte et toutes vos données de nos serveurs.',
            willBeDeleted: 'Les éléments suivants seront supprimés:',
            allSubscriptions: 'Tous vos abonnements Twitter',
            savedNews: 'Toutes les actualités enregistrées',
            accountSettings: 'Vos paramètres et préférences de compte',
            telegramConnection: 'Connexion au bot Telegram',
            typeDelete: 'Tapez DELETE pour confirmer:',
            deleteAccountFinal: 'Supprimer Mon Compte',
            typeDELETE: 'Veuillez taper DELETE pour confirmer',
